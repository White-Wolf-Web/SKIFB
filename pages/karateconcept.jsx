	...
	return (
		<main>
			<div className="p-reduit">
				...
				<p className="text-center p-margin-bottom5">
					<strong>{t("karate_concept.concept_p5")}</strong>
				</p>

				<p className="p-margin-bottom3">
					<strong>{t("karate_concept.concept_p6")}</strong>
					{t("karate_concept.concept_p6bis")}
				</p>
				<p className="p-margin-bottom3">{t("karate_concept.concept_p6ter")}</p>
				<p>{t("karate_concept.concept_p6quater")}</p>

				<p className="p-margin-bottom3">
					<strong>{t("karate_concept.concept_p7")}</strong>
					{t("karate_concept.concept_p7bis")}
				</p>
				<p className="p-margin-bottom5">{t("karate_concept.concept_p7ter")}</p>

				<p className="p-margin-bottom3">
					{t("karate_concept.concept_p8")}
					<strong>{t("karate_concept.concept_p8bis")}</strong>
					{t("karate_concept.concept_p8ter")}
				</p>
				...
				<p className="p-margin-bottom3">
					<strong>{t("karate_concept.concept_p10ter")}</strong>
				</p>
				<p className="p-margin-bottom3">{t("karate_concept.concept_p10quater")}</p>
				<p className="p-margin-bottom3">
					<strong>{t("karate_concept.concept_p10quinquies")}</strong>
				</p>
				<p>{t("karate_concept.concept_p10sexies")}</p>

				<p className="p-margin-bottom3">{t("karate_concept.concept_p11")}</p>
				<p className="p-margin-bottom3">
					<strong>{t("karate_concept.concept_p11bis")}</strong>
				</p>
				<p>{t("karate_concept.concept_p11ter")}</p>

				<p className="p-margin-bottom3">
					<strong>{t("karate_concept.concept_p12")}</strong>
					{t("karate_concept.concept_p12bis")}
				</p>
				...
				<p className="p-margin-bottom3">
					<strong>{t("karate_concept.concept_p17")}</strong>
				</p>
...
export async function getStaticProps({ locale }) {
	return {
		props: {
			...(await serverSideTranslations(locale, ["karateconcept"])),
		},
	};
}
